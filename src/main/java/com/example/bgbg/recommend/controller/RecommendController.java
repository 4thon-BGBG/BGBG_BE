...
public class RecommendController {
    ...
    public ResponseEntity<?> getRecommendation(@Parameter(description = "추천받고 싶은 메뉴 이름")
        ...
        List<IngredientResponse> ingredients = recommendedItemService.getAndSaveRecommendations(menu, user);
    ...
    @Operation(summary = "추천 품목 전체 장보기 리스트에 추가", description = "추천받은 품목 전체를 특정 장보기 리스트에 추가 (개수=1, 메모=null)")
    @PostMapping("/add-to-list")
    public ResponseEntity<?> addAllToShoppingList(@Parameter(description = "추가할 장보기 리스트 ID")
